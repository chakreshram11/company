...
function Header() {
  ...
  return (
    <div className="flex items-center justify-between bg-gray-100 h-16 w-full p-4 shadow-md">
      ...
      <div className={`${isOpen ? "block" : "hidden"} text-center absolute top-16 left-0 w-full bg-gray-100 md:hidden z-50`}>
        ...
        <Link to="/project" className="text-lg font-medium text-gray-700 hover:text-blue-600 transition-colors duration-200 block py-2" onClick={toggleMenu}>Projects</Link>
